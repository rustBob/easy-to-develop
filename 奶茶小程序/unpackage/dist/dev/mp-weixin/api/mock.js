    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        ...
        resolve({
          ...
          pickupCode: isPickup ? Math.floor(Math.random() * 9e3) + 1e3 : null,
          estimatedTime: now + (isPickup ? 15 * 6e4 : 30 * 6e4),
          // +15min or +30min
          ...
          deliveryStatus: !isPickup ? "waiting_rider" : null
          // waiting_rider, delivering, arrived
        });
      }, 1e3);
    });
  },
